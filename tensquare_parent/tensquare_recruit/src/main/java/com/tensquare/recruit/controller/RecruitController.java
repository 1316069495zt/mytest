...
public class RecruitController {
	...
	public Result findByRecommend(){
        List<Recruit> byhot = recruitService.findByhot("2");
        return new Result(true,StatusCode.OK,"查询成功",byhot);
	}

	@GetMapping("/search/newlist")
    public Result findBynew(){
        List<Recruit> byhot = recruitService.findBynew("0");
        return new Result(true,StatusCode.OK,"查询成功",byhot);
