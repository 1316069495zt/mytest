...
public class ProblemController {
	...
	public Result clientQa(@PathVariable String labelId){
	...
	public Result newList(@PathVariable String label ,@PathVariable int page ,@PathVariable int size){
        Page<Problem> problems = problemService.newLista(label, page, size);
    ...
    public Result hostList(@PathVariable String label ,@PathVariable int page ,@PathVariable int size){
        Page<Problem> problems = problemService.hostLista(label, page, size);
        return new Result(true,StatusCode.OK,"查询成功",new PageResult<Problem>(problems.getTotalElements(),problems.getContent()));
    ...
    public Result waitList(@PathVariable String label ,@PathVariable int page ,@PathVariable int size){
        Page<Problem> problems = problemService.waitLista(label, page, size);
        return new Result(true,StatusCode.OK,"查询成功",new PageResult<Problem>(problems.getTotalElements(),problems.getContent()));
